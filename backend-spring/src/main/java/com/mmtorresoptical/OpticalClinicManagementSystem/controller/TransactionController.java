...
public class TransactionController {
    ...
    @GetMapping("/daily-cash-inflow")
    public ResponseEntity<List<DailyCashInflowPoint>> getDailyCashInflow() {
        return ResponseEntity.ok(transactionService.getDailyCashInflow());
    }
