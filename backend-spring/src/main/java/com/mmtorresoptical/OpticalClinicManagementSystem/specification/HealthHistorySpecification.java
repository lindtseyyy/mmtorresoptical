...
public class HealthHistorySpecification {

    public static Specification<HealthHistory> hasPatientId(UUID patientId) {
        return (root, query, cb) ->
                cb.equal(root.get("patient").get("patientId"), patientId);
    }

    public static Specification<HealthHistory> hasArchivedStatus(String status) {
        return (root, query, cb) -> {
    ...
    public static Specification<HealthHistory> dateBetween(LocalDate minDate, LocalDate maxDate) {
        return (root, query, cb) -> {
